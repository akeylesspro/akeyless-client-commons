export const sortSvg = (upside_down?: boolean) => {
    return (
        ...
        >
            <g transform="translate(0.000000,1536.000000) scale(0.100000,-0.100000)" fill="#fff" stroke="none">
...
export const slashFilterSvg = (solid?: boolean, color?: string) => {
    return (
        <>
            {solid ? (
                <div className="mt-[-4px] mr-[-2px] ">
                    <svg
                        ...
                        preserveAspectRatio="xMidYMid meet"
                    >
                        <g transform="translate(0.000000,900.000000) scale(0.100000,-0.100000)" fill={color ?? "#fff"} stroke="none">
