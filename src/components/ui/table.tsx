...
const TableSCN = React.forwardRef<
  HTMLTableElement,
...
const TableHeaderSCN = React.forwardRef<
...
const TableBodySCN = React.forwardRef<
  HTMLTableSectionElement,
  React.HTMLAttributes<HTMLTableSectionElement>
>(({ className, ...props }, ref) => (
  <tbody
...
const TableFooterSCN = React.forwardRef<
  HTMLTableSectionElement,
  React.HTMLAttributes<HTMLTableSectionElement>
>(({ className, ...props }, ref) => (
  <tfoot
...
const TableRowSCN = React.forwardRef<
  HTMLTableRowElement,
...
const TableHeadSCN = React.forwardRef<
...
const TableCellSCN = React.forwardRef<
  HTMLTableCellElement,
...
const TableCaptionSCN = React.forwardRef<
