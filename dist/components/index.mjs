...
function ChangeDocumentTitle(param) {
    var _param_title = param.title, title = _param_title === void 0 ? "Akeyless" : _param_title;
    useEffect(function() {
        ...
        },
        {
            ...
            value: function render() {
                if (this.state.hasError) {
                    return this.props.fallback || /* @__PURE__ */ jsx3("div", {
                        className: "full center",
                        children: /* @__PURE__ */ jsx3("h1", {
                            children: "\u05DE\u05E9\u05D4\u05D5 \u05D4\u05E9\u05EA\u05D1\u05E9...."
                        })
                    });
                }
...
var Loader = function(param) {
    ...
    return /* @__PURE__ */ jsx4("div", {
        ...
        style: style,
        children: /* @__PURE__ */ jsx4(ClipLoader, {
            loading: true,
            color: color || "#699A2C",
            size: size || 18
        })
            ...
            children: headers.map(function(header, index) {
                ...
                return /* @__PURE__ */ jsxs4("th", {
                    ...
                    children: [
                        ...
                        sortDisplay && sortColumn === index && (sortOrder === "asc" ? /* @__PURE__ */ jsx7(Fragment3, {
                            children: sortSvg()
    ...
    return /* @__PURE__ */ jsxs4(Fragment3, {
        children: [
            /* @__PURE__ */ jsx7("button", {
                ...
                children: filterPopupsDisplay === filterableColumn.dataKey ? /* @__PURE__ */ jsx7(Fragment3, {
                    children: ((_filters_filterableColumn_dataKey = filters[filterableColumn.dataKey]) === null || _filters_filterableColumn_dataKey === void 0 ? void 0 : _filters_filterableColumn_dataKey.length) > 0 ? /* @__PURE__ */ jsx7(Fragment3, {
                        children: slashFilterSvg(true)
                    }) : /* @__PURE__ */ jsx7(Fragment3, {
                        children: emptyFilterSvg(true)
                    })
                }) : /* @__PURE__ */ jsx7(Fragment3, {
                    children: ((_filters_filterableColumn_dataKey1 = filters[filterableColumn.dataKey]) === null || _filters_filterableColumn_dataKey1 === void 0 ? void 0 : _filters_filterableColumn_dataKey1.length) > 0 ? /* @__PURE__ */ jsx7(Fragment3, {
